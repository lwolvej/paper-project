...
(
  ...
  `journal_expect_cited_times` VARCHAR(16)  NOT NULL,
  `subject_expect_cited_times` VARCHAR(16)  NOT NULL,
  `journal_influence`          VARCHAR(16)  NOT NULL,
  `subject_influence`          VARCHAR(16)  NOT NULL,
  `subject_area_percentile`    VARCHAR(16)  NOT NULL,
