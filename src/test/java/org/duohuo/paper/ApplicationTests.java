...
//        try (InputStream inputStream = new FileInputStream("/Users/lwolvej/Desktop/ESIMasterJournalList-082018.xlsx")) {
...
//        System.out.println(baseLineSearchService.searchByAll());
//    }
//
//    @Test
...
//
//    @Test
//    public void zipFile1() throws Exception {
//        ZipOutputStream outputStream = new ZipOutputStream(new FileOutputStream("/Users/lwolvej/Desktop/test1.zip"));
//        for (int i = 0; i < 10; i++) {
//            String a = Integer.toString(i + 100);
//            ZipParameters zipParameters = new ZipParameters();
//            zipParameters.setSourceExternalStream(true);
//            zipParameters.setFileNameInZip(i + ".txt");
//            outputStream.putNextEntry(null, zipParameters);
...
//
//    @Test
//    public void journalManagerTest1() {
//        List<Long> journalIdList = new ArrayList<>();
//        journalIdList.add(11730L);
//        journalIdList.add(1110L);
//        journalIdList.add(123L);
//        PageRequest pageRequest = PageRequest.of(0, 2);
////        System.out.println(journalManager.findAllByIdList(journalIdList, pageRequest).getContent());
//        System.out.println(String.valueOf((Object) pageRequest));
//    }
//
//    @Test
